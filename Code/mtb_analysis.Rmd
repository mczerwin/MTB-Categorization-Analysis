...
We see that out of our `r nrow(mtb_data)` bikes, most of them are Trail bikes.
...
```
- To the right, we see that most of the bikes don’t have a setting, which is used to help differentiate between different versions of the same bike.  
- Most of the bikes being analyzed are trail bikes, with the smallest grouping of bikes being all mountain bikes.  
...
- Most of the bikes that have 2 pistons are Cross Country (*xc*) bikes.
