...
With all of the factors to consider when designing a bike, there are no clear boundaries between these categories. For example, one brand's Downcountry bike could be what another brand considers a Trail bike. The popular mountain biking website PinkBike has done in depth analyses of many bikes across all categories, and the topic as to which category bikes fall in and how many categories is too many often comes up, as seen in the video [here](https://www.youtube.com/watch?v=JYQJbymyG6k&ab_channel=Pinkbike). 
